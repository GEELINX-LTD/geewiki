...
│   ├── web/          # React 19 管理台 @geewiki/web（Vite 6，6 态 wiki 路由 + #/plugins + #/graph + 命令面板；fixtures/ 为 Slot 验证用示例插件 UI）
